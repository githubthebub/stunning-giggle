...
- Introduce the Dex character fully (video 3 at the latest), plant the glitch
  lore (Episode 2), start Binder Resurrection with *digital* submissions
  (photos — no mail logistics yet).
...
| 1k→100k timeline | 9–24 months documented range | Anyone promising faster is selling something |
...
- The finale giveaway costs less than $100 and is worth more than any sponsor.
